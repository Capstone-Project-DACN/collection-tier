 ...
 */
function generateRandomDeviceId(cityId, districtId, type = DATA_TYPE.household) {
    if (type === DATA_TYPE.household) {
        return `household-${cityId? cityId: 'undefined'}-${districtId? districtId: 'undefined'}-${randomHelper.getRandomInt(ALLOWED_DEVICE_ID.START, ALLOWED_DEVICE_ID.END)}`
